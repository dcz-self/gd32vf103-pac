...
pub type R = crate::R<CH5MADDR_SPEC>;
#[doc = "Register `CH5MADDR` writer"]
pub type W = crate::W<CH5MADDR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn maddr(&mut self) -> MADDR_W<CH5MADDR_SPEC> {
        MADDR_W::new(self, 0)
    }
}
...
pub struct CH5MADDR_SPEC;
impl crate::RegisterSpec for CH5MADDR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ch5maddr::R`](R) reader structure"]
impl crate::Readable for CH5MADDR_SPEC {}
#[doc = "`write(|w| ..)` method takes [`ch5maddr::W`](W) writer structure"]
impl crate::Writable for CH5MADDR_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CH5MADDR to value 0"]
impl crate::Resettable for CH5MADDR_SPEC {
