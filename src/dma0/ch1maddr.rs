...
pub type R = crate::R<CH1MADDR_SPEC>;
#[doc = "Register `CH1MADDR` writer"]
pub type W = crate::W<CH1MADDR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn maddr(&mut self) -> MADDR_W<CH1MADDR_SPEC> {
        MADDR_W::new(self, 0)
    }
}
#[doc = "Channel 1 memory base address register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ch1maddr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ch1maddr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CH1MADDR_SPEC;
impl crate::RegisterSpec for CH1MADDR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ch1maddr::R`](R) reader structure"]
impl crate::Readable for CH1MADDR_SPEC {}
#[doc = "`write(|w| ..)` method takes [`ch1maddr::W`](W) writer structure"]
impl crate::Writable for CH1MADDR_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CH1MADDR to value 0"]
impl crate::Resettable for CH1MADDR_SPEC {
