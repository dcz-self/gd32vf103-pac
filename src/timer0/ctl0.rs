...
pub type CAM_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
...
pub type CKDIV_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dir(&mut self) -> DIR_W<CTL0_SPEC> {
        DIR_W::new(self, 4)
    }
    #[doc = "Bits 5:6 - Counter aligns mode selection"]
    #[inline(always)]
    #[must_use]
    pub fn cam(&mut self) -> CAM_W<CTL0_SPEC> {
        CAM_W::new(self, 5)
    }
    #[doc = "Bit 7 - Auto-reload shadow enable"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn ckdiv(&mut self) -> CKDIV_W<CTL0_SPEC> {
        CKDIV_W::new(self, 8)
    }
}
