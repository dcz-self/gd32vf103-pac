...
pub type CMTG_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type BRKG_W<'a, REG> = crate::BitWriter<'a, REG>;
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cmtg(&mut self) -> CMTG_W<SWEVG_SPEC> {
        CMTG_W::new(self, 5)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn brkg(&mut self) -> BRKG_W<SWEVG_SPEC> {
        BRKG_W::new(self, 7)
    }
