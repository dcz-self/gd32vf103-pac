#![doc = "Peripheral access API for GD32VF103 microcontrollers (generated using svd2rust v0.33.5 (59b6199 2024-10-15))\n\nYou can find an overview of the generated API [here].\n\nAPI features to be included in the [next]
...
impl Peripherals {
    ...
    pub unsafe fn steal() -> Self {
        ...
        Peripherals {
            ...
            UART3: UART3::steal(),
            UART4: UART4::steal(),
            USBFS_GLOBAL: USBFS_GLOBAL::steal(),
            USBFS_HOST: USBFS_HOST::steal(),
            USBFS_DEVICE: USBFS_DEVICE::steal(),
            USBFS_PWRCLK: USBFS_PWRCLK::steal(),
            WWDGT: WWDGT::steal(),
            CTIMER: CTIMER::steal(),
        }
    }
