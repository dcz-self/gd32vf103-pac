...
pub type R = crate::R<DIEP2INTF_SPEC>;
#[doc = "Register `DIEP2INTF` writer"]
pub type W = crate::W<DIEP2INTF_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tf(&mut self) -> TF_W<DIEP2INTF_SPEC> {
        TF_W::new(self, 0)
    }
    #[doc = "Bit 1 - Endpoint finished"]
    #[inline(always)]
    #[must_use]
    pub fn epdis(&mut self) -> EPDIS_W<DIEP2INTF_SPEC> {
        EPDIS_W::new(self, 1)
    }
    #[doc = "Bit 3 - Control in timeout interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn cito(&mut self) -> CITO_W<DIEP2INTF_SPEC> {
        CITO_W::new(self, 3)
    }
    #[doc = "Bit 4 - Endpoint Tx FIFO underrun"]
    #[inline(always)]
    #[must_use]
    pub fn eptxfud(&mut self) -> EPTXFUD_W<DIEP2INTF_SPEC> {
        EPTXFUD_W::new(self, 4)
    }
    #[doc = "Bit 6 - IN endpoint NAK effective"]
    #[inline(always)]
    #[must_use]
    pub fn iepne(&mut self) -> IEPNE_W<DIEP2INTF_SPEC> {
        IEPNE_W::new(self, 6)
    }
}
#[doc = "device endpoint-2 interrupt register\n\nYou can [`read`](crate::Reg::read) this register and get [`diep2intf::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`diep2intf::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DIEP2INTF_SPEC;
impl crate::RegisterSpec for DIEP2INTF_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`diep2intf::R`](R) reader structure"]
impl crate::Readable for DIEP2INTF_SPEC {}
#[doc = "`write(|w| ..)` method takes [`diep2intf::W`](W) writer structure"]
impl crate::Writable for DIEP2INTF_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DIEP2INTF to value 0x80"]
impl crate::Resettable for DIEP2INTF_SPEC {
