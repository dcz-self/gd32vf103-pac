#[doc = "Register `HCH7INTEN` reader"]
pub type R = crate::R<HCH7INTEN_SPEC>;
#[doc = "Register `HCH7INTEN` writer"]
pub type W = crate::W<HCH7INTEN_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tfie(&mut self) -> TFIE_W<HCH7INTEN_SPEC> {
        TFIE_W::new(self, 0)
    }
    #[doc = "Bit 1 - Channel halted interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn chie(&mut self) -> CHIE_W<HCH7INTEN_SPEC> {
        CHIE_W::new(self, 1)
    }
    #[doc = "Bit 3 - STALL interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn stallie(&mut self) -> STALLIE_W<HCH7INTEN_SPEC> {
        STALLIE_W::new(self, 3)
    }
    #[doc = "Bit 4 - NAK interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn nakie(&mut self) -> NAKIE_W<HCH7INTEN_SPEC> {
        NAKIE_W::new(self, 4)
    }
    #[doc = "Bit 5 - ACK interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn ackie(&mut self) -> ACKIE_W<HCH7INTEN_SPEC> {
        ACKIE_W::new(self, 5)
    }
    #[doc = "Bit 7 - USB bus error interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn usberie(&mut self) -> USBERIE_W<HCH7INTEN_SPEC> {
        USBERIE_W::new(self, 7)
    }
    #[doc = "Bit 8 - Babble error interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn bberie(&mut self) -> BBERIE_W<HCH7INTEN_SPEC> {
        BBERIE_W::new(self, 8)
    }
    #[doc = "Bit 9 - request queue overrun interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn reqovrie(&mut self) -> REQOVRIE_W<HCH7INTEN_SPEC> {
        REQOVRIE_W::new(self, 9)
    }
    #[doc = "Bit 10 - Data toggle error interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn dterie(&mut self) -> DTERIE_W<HCH7INTEN_SPEC> {
        DTERIE_W::new(self, 10)
    }
}
#[doc = "host channel-7 interrupt enable register (HCH7INTEN)\n\nYou can [`read`](crate::Reg::read) this register and get [`hch7inten::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`hch7inten::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HCH7INTEN_SPEC;
impl crate::RegisterSpec for HCH7INTEN_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hch7inten::R`](R) reader structure"]
impl crate::Readable for HCH7INTEN_SPEC {}
#[doc = "`write(|w| ..)` method takes [`hch7inten::W`](W) writer structure"]
impl crate::Writable for HCH7INTEN_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets HCH7INTEN to value 0"]
impl crate::Resettable for HCH7INTEN_SPEC {
