...
pub type R = crate::R<HCH4INTEN_SPEC>;
#[doc = "Register `HCH4INTEN` writer"]
pub type W = crate::W<HCH4INTEN_SPEC>;
...
#[doc = "host channel-4 interrupt enable register (HCH4INTEN)\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`hch4inten::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`hch4inten::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HCH4INTEN_SPEC;
impl crate::RegisterSpec for HCH4INTEN_SPEC {
    type Ux = u32;
}
