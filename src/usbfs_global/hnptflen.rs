...
pub type HNPTXRSAR_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
...
pub type HNPTXFD_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn hnptxrsar(&mut self) -> HNPTXRSAR_W<HNPTFLEN_SPEC> {
        HNPTXRSAR_W::new(self, 0)
    }
    #[doc = "Bits 16:31 - host non-periodic TxFIFO depth"]
    #[inline(always)]
    #[must_use]
    pub fn hnptxfd(&mut self) -> HNPTXFD_W<HNPTFLEN_SPEC> {
        HNPTXFD_W::new(self, 16)
    }
}
