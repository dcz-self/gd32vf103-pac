...
pub type R = crate::R<DATA41_SPEC>;
#[doc = "Register `DATA41` writer"]
pub type W = crate::W<DATA41_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn data(&mut self) -> DATA_W<DATA41_SPEC> {
        DATA_W::new(self, 0)
    }
}
...
pub struct DATA41_SPEC;
impl crate::RegisterSpec for DATA41_SPEC {
    type Ux = u16;
}
#[doc = "`read()` method returns [`data41::R`](R) reader structure"]
impl crate::Readable for DATA41_SPEC {}
#[doc = "`write(|w| ..)` method takes [`data41::W`](W) writer structure"]
impl crate::Writable for DATA41_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
#[doc = "`reset()` method sets DATA41 to value 0"]
impl crate::Resettable for DATA41_SPEC {
