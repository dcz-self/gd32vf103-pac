...
pub type R = crate::R<DATA37_SPEC>;
#[doc = "Register `DATA37` writer"]
pub type W = crate::W<DATA37_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn data(&mut self) -> DATA_W<DATA37_SPEC> {
        DATA_W::new(self, 0)
    }
}
...
pub struct DATA37_SPEC;
impl crate::RegisterSpec for DATA37_SPEC {
    type Ux = u16;
}
#[doc = "`read()` method returns [`data37::R`](R) reader structure"]
impl crate::Readable for DATA37_SPEC {}
#[doc = "`write(|w| ..)` method takes [`data37::W`](W) writer structure"]
impl crate::Writable for DATA37_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
#[doc = "`reset()` method sets DATA37 to value 0"]
impl crate::Resettable for DATA37_SPEC {
