...
pub type R = crate::R<DATA22_SPEC>;
#[doc = "Register `DATA22` writer"]
pub type W = crate::W<DATA22_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn data(&mut self) -> DATA_W<DATA22_SPEC> {
        DATA_W::new(self, 0)
    }
...
pub struct DATA22_SPEC;
impl crate::RegisterSpec for DATA22_SPEC {
    type Ux = u16;
}
#[doc = "`read()` method returns [`data22::R`](R) reader structure"]
impl crate::Readable for DATA22_SPEC {}
#[doc = "`write(|w| ..)` method takes [`data22::W`](W) writer structure"]
impl crate::Writable for DATA22_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
#[doc = "`reset()` method sets DATA22 to value 0"]
impl crate::Resettable for DATA22_SPEC {
