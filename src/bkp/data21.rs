...
pub type R = crate::R<DATA21_SPEC>;
#[doc = "Register `DATA21` writer"]
pub type W = crate::W<DATA21_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn data(&mut self) -> DATA_W<DATA21_SPEC> {
        DATA_W::new(self, 0)
    }
}
...
pub struct DATA21_SPEC;
impl crate::RegisterSpec for DATA21_SPEC {
    type Ux = u16;
}
#[doc = "`read()` method returns [`data21::R`](R) reader structure"]
impl crate::Readable for DATA21_SPEC {}
#[doc = "`write(|w| ..)` method takes [`data21::W`](W) writer structure"]
impl crate::Writable for DATA21_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
#[doc = "`reset()` method sets DATA21 to value 0"]
impl crate::Resettable for DATA21_SPEC {
