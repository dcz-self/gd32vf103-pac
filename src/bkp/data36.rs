...
pub type R = crate::R<DATA36_SPEC>;
#[doc = "Register `DATA36` writer"]
pub type W = crate::W<DATA36_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn data(&mut self) -> DATA_W<DATA36_SPEC> {
        DATA_W::new(self, 0)
    }
...
pub struct DATA36_SPEC;
impl crate::RegisterSpec for DATA36_SPEC {
    type Ux = u16;
}
#[doc = "`read()` method returns [`data36::R`](R) reader structure"]
impl crate::Readable for DATA36_SPEC {}
#[doc = "`write(|w| ..)` method takes [`data36::W`](W) writer structure"]
impl crate::Writable for DATA36_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
#[doc = "`reset()` method sets DATA36 to value 0"]
impl crate::Resettable for DATA36_SPEC {
