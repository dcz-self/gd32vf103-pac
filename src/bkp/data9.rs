...
pub type R = crate::R<DATA9_SPEC>;
#[doc = "Register `DATA9` writer"]
pub type W = crate::W<DATA9_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn data(&mut self) -> DATA_W<DATA9_SPEC> {
        DATA_W::new(self, 0)
    }
}
#[doc = "Backup data register 9\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`data9::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`data9::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
