...
pub type R = crate::R<DATA35_SPEC>;
#[doc = "Register `DATA35` writer"]
pub type W = crate::W<DATA35_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn data(&mut self) -> DATA_W<DATA35_SPEC> {
        DATA_W::new(self, 0)
    }
}
#[doc = "Backup data register 35\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`data35::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`data35::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DATA35_SPEC;
impl crate::RegisterSpec for DATA35_SPEC {
    type Ux = u16;
}
#[doc = "`read()` method returns [`data35::R`](R) reader structure"]
impl crate::Readable for DATA35_SPEC {}
#[doc = "`write(|w| ..)` method takes [`data35::W`](W) writer structure"]
impl crate::Writable for DATA35_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
#[doc = "`reset()` method sets DATA35 to value 0"]
impl crate::Resettable for DATA35_SPEC {
