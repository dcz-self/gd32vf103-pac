...
pub type R = crate::R<DATA30_SPEC>;
#[doc = "Register `DATA30` writer"]
pub type W = crate::W<DATA30_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn data(&mut self) -> DATA_W<DATA30_SPEC> {
        DATA_W::new(self, 0)
    }
...
#[doc = "Backup data register 30\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`data30::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`data30::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
