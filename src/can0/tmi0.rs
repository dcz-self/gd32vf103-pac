...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ten(&mut self) -> TEN_W<TMI0_SPEC> {
        TEN_W::new(self, 0)
    }
    #[doc = "Bit 1 - Frame type"]
    #[inline(always)]
    #[must_use]
    pub fn ft(&mut self) -> FT_W<TMI0_SPEC> {
        FT_W::new(self, 1)
    }
    #[doc = "Bit 2 - Frame format"]
    #[inline(always)]
    #[must_use]
    pub fn ff(&mut self) -> FF_W<TMI0_SPEC> {
        FF_W::new(self, 2)
    }
    #[doc = "Bits 3:20 - The frame identifier"]
    #[inline(always)]
    #[must_use]
    pub fn efid(&mut self) -> EFID_W<TMI0_SPEC> {
        EFID_W::new(self, 3)
    }
    #[doc = "Bits 21:31 - The frame identifier"]
    #[inline(always)]
    #[must_use]
    pub fn sfid_efid(&mut self) -> SFID_EFID_W<TMI0_SPEC> {
