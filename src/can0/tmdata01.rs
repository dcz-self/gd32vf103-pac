...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn db0(&mut self) -> DB0_W<TMDATA01_SPEC> {
        DB0_W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Data byte 1"]
    #[inline(always)]
    #[must_use]
    pub fn db1(&mut self) -> DB1_W<TMDATA01_SPEC> {
        DB1_W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Data byte 2"]
    #[inline(always)]
    #[must_use]
    pub fn db2(&mut self) -> DB2_W<TMDATA01_SPEC> {
        DB2_W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Data byte 3"]
    #[inline(always)]
    #[must_use]
    pub fn db3(&mut self) -> DB3_W<TMDATA01_SPEC> {
        DB3_W::new(self, 24)
    }
