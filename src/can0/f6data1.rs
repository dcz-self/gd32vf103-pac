...
pub type R = crate::R<F6DATA1_SPEC>;
#[doc = "Register `F6DATA1` writer"]
pub type W = crate::W<F6DATA1_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn fd0(&mut self) -> FD0_W<F6DATA1_SPEC> {
        FD0_W::new(self, 0)
    }
    #[doc = "Bit 1 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fd1(&mut self) -> FD1_W<F6DATA1_SPEC> {
        FD1_W::new(self, 1)
    }
    #[doc = "Bit 2 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fd2(&mut self) -> FD2_W<F6DATA1_SPEC> {
        FD2_W::new(self, 2)
    }
    #[doc = "Bit 3 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fd3(&mut self) -> FD3_W<F6DATA1_SPEC> {
        FD3_W::new(self, 3)
    }
    #[doc = "Bit 4 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fd4(&mut self) -> FD4_W<F6DATA1_SPEC> {
        FD4_W::new(self, 4)
    }
    #[doc = "Bit 5 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fd5(&mut self) -> FD5_W<F6DATA1_SPEC> {
        FD5_W::new(self, 5)
    }
    #[doc = "Bit 6 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fd6(&mut self) -> FD6_W<F6DATA1_SPEC> {
        FD6_W::new(self, 6)
    }
    #[doc = "Bit 7 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fd7(&mut self) -> FD7_W<F6DATA1_SPEC> {
        FD7_W::new(self, 7)
    }
    #[doc = "Bit 8 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fd8(&mut self) -> FD8_W<F6DATA1_SPEC> {
        FD8_W::new(self, 8)
    }
    #[doc = "Bit 9 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fd9(&mut self) -> FD9_W<F6DATA1_SPEC> {
        FD9_W::new(self, 9)
    }
    #[doc = "Bit 10 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fd10(&mut self) -> FD10_W<F6DATA1_SPEC> {
        FD10_W::new(self, 10)
    }
    #[doc = "Bit 11 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fd11(&mut self) -> FD11_W<F6DATA1_SPEC> {
        FD11_W::new(self, 11)
    }
    #[doc = "Bit 12 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fd12(&mut self) -> FD12_W<F6DATA1_SPEC> {
        FD12_W::new(self, 12)
    }
    #[doc = "Bit 13 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fd13(&mut self) -> FD13_W<F6DATA1_SPEC> {
        FD13_W::new(self, 13)
    }
    #[doc = "Bit 14 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fd14(&mut self) -> FD14_W<F6DATA1_SPEC> {
        FD14_W::new(self, 14)
    }
    #[doc = "Bit 15 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fd15(&mut self) -> FD15_W<F6DATA1_SPEC> {
        FD15_W::new(self, 15)
    }
    #[doc = "Bit 16 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fd16(&mut self) -> FD16_W<F6DATA1_SPEC> {
        FD16_W::new(self, 16)
    }
    #[doc = "Bit 17 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fd17(&mut self) -> FD17_W<F6DATA1_SPEC> {
        FD17_W::new(self, 17)
    }
    #[doc = "Bit 18 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fd18(&mut self) -> FD18_W<F6DATA1_SPEC> {
        FD18_W::new(self, 18)
    }
    #[doc = "Bit 19 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fd19(&mut self) -> FD19_W<F6DATA1_SPEC> {
        FD19_W::new(self, 19)
    }
    #[doc = "Bit 20 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fd20(&mut self) -> FD20_W<F6DATA1_SPEC> {
        FD20_W::new(self, 20)
    }
    #[doc = "Bit 21 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fd21(&mut self) -> FD21_W<F6DATA1_SPEC> {
        FD21_W::new(self, 21)
    }
    #[doc = "Bit 22 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fd22(&mut self) -> FD22_W<F6DATA1_SPEC> {
        FD22_W::new(self, 22)
    }
    #[doc = "Bit 23 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fd23(&mut self) -> FD23_W<F6DATA1_SPEC> {
        FD23_W::new(self, 23)
    }
    #[doc = "Bit 24 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fd24(&mut self) -> FD24_W<F6DATA1_SPEC> {
        FD24_W::new(self, 24)
    }
    #[doc = "Bit 25 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fd25(&mut self) -> FD25_W<F6DATA1_SPEC> {
        FD25_W::new(self, 25)
    }
    #[doc = "Bit 26 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fd26(&mut self) -> FD26_W<F6DATA1_SPEC> {
        FD26_W::new(self, 26)
    }
    #[doc = "Bit 27 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fd27(&mut self) -> FD27_W<F6DATA1_SPEC> {
        FD27_W::new(self, 27)
    }
    #[doc = "Bit 28 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fd28(&mut self) -> FD28_W<F6DATA1_SPEC> {
        FD28_W::new(self, 28)
    }
    #[doc = "Bit 29 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fd29(&mut self) -> FD29_W<F6DATA1_SPEC> {
        FD29_W::new(self, 29)
    }
    #[doc = "Bit 30 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fd30(&mut self) -> FD30_W<F6DATA1_SPEC> {
        FD30_W::new(self, 30)
    }
    #[doc = "Bit 31 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fd31(&mut self) -> FD31_W<F6DATA1_SPEC> {
        FD31_W::new(self, 31)
    }
}
#[doc = "Filter 6 data 1 register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`f6data1::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`f6data1::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct F6DATA1_SPEC;
impl crate::RegisterSpec for F6DATA1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`f6data1::R`](R) reader structure"]
impl crate::Readable for F6DATA1_SPEC {}
#[doc = "`write(|w| ..)` method takes [`f6data1::W`](W) writer structure"]
impl crate::Writable for F6DATA1_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets F6DATA1 to value 0"]
impl crate::Resettable for F6DATA1_SPEC {
