...
pub type FS0_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type FS1_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type FS2_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type FS3_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type FS4_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type FS5_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type FS6_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type FS7_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type FS8_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type FS9_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type FS10_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type FS11_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type FS12_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn fs0(&mut self) -> FS0_W<FSCFG_SPEC> {
        FS0_W::new(self, 0)
    }
    #[doc = "Bit 1 - Filter scale configuration"]
    #[inline(always)]
    #[must_use]
    pub fn fs1(&mut self) -> FS1_W<FSCFG_SPEC> {
        FS1_W::new(self, 1)
    }
    #[doc = "Bit 2 - Filter scale configuration"]
    #[inline(always)]
    #[must_use]
    pub fn fs2(&mut self) -> FS2_W<FSCFG_SPEC> {
        FS2_W::new(self, 2)
    }
    #[doc = "Bit 3 - Filter scale configuration"]
    #[inline(always)]
    #[must_use]
    pub fn fs3(&mut self) -> FS3_W<FSCFG_SPEC> {
        FS3_W::new(self, 3)
    }
    #[doc = "Bit 4 - Filter scale configuration"]
    #[inline(always)]
    #[must_use]
    pub fn fs4(&mut self) -> FS4_W<FSCFG_SPEC> {
        FS4_W::new(self, 4)
    }
    #[doc = "Bit 5 - Filter scale configuration"]
    #[inline(always)]
    #[must_use]
    pub fn fs5(&mut self) -> FS5_W<FSCFG_SPEC> {
        FS5_W::new(self, 5)
    }
    #[doc = "Bit 6 - Filter scale configuration"]
    #[inline(always)]
    #[must_use]
    pub fn fs6(&mut self) -> FS6_W<FSCFG_SPEC> {
        FS6_W::new(self, 6)
    }
    #[doc = "Bit 7 - Filter scale configuration"]
    #[inline(always)]
    #[must_use]
    pub fn fs7(&mut self) -> FS7_W<FSCFG_SPEC> {
        FS7_W::new(self, 7)
    }
    #[doc = "Bit 8 - Filter scale configuration"]
    #[inline(always)]
    #[must_use]
    pub fn fs8(&mut self) -> FS8_W<FSCFG_SPEC> {
        FS8_W::new(self, 8)
    }
    #[doc = "Bit 9 - Filter scale configuration"]
    #[inline(always)]
    #[must_use]
    pub fn fs9(&mut self) -> FS9_W<FSCFG_SPEC> {
        FS9_W::new(self, 9)
    }
    #[doc = "Bit 10 - Filter scale configuration"]
    #[inline(always)]
    #[must_use]
    pub fn fs10(&mut self) -> FS10_W<FSCFG_SPEC> {
        FS10_W::new(self, 10)
    }
    #[doc = "Bit 11 - Filter scale configuration"]
    #[inline(always)]
    #[must_use]
    pub fn fs11(&mut self) -> FS11_W<FSCFG_SPEC> {
        FS11_W::new(self, 11)
    }
    #[doc = "Bit 12 - Filter scale configuration"]
    #[inline(always)]
    #[must_use]
    pub fn fs12(&mut self) -> FS12_W<FSCFG_SPEC> {
        FS12_W::new(self, 12)
    }
    #[doc = "Bit 13 - Filter scale configuration"]
    #[inline(always)]
    #[must_use]
    pub fn fs13(&mut self) -> FS13_W<FSCFG_SPEC> {
        FS13_W::new(self, 13)
    }
    #[doc = "Bit 14 - Filter scale configuration"]
    #[inline(always)]
    #[must_use]
    pub fn fs14(&mut self) -> FS14_W<FSCFG_SPEC> {
        FS14_W::new(self, 14)
    }
    #[doc = "Bit 15 - Filter scale configuration"]
    #[inline(always)]
    #[must_use]
    pub fn fs15(&mut self) -> FS15_W<FSCFG_SPEC> {
        FS15_W::new(self, 15)
    }
    #[doc = "Bit 16 - Filter scale configuration"]
    #[inline(always)]
    #[must_use]
    pub fn fs16(&mut self) -> FS16_W<FSCFG_SPEC> {
        FS16_W::new(self, 16)
    }
    #[doc = "Bit 17 - Filter scale configuration"]
    #[inline(always)]
    #[must_use]
    pub fn fs17(&mut self) -> FS17_W<FSCFG_SPEC> {
        FS17_W::new(self, 17)
    }
    #[doc = "Bit 18 - Filter scale configuration"]
    #[inline(always)]
    #[must_use]
    pub fn fs18(&mut self) -> FS18_W<FSCFG_SPEC> {
        FS18_W::new(self, 18)
    }
    #[doc = "Bit 19 - Filter scale configuration"]
    #[inline(always)]
    #[must_use]
    pub fn fs19(&mut self) -> FS19_W<FSCFG_SPEC> {
        FS19_W::new(self, 19)
    }
    #[doc = "Bit 20 - Filter scale configuration"]
    #[inline(always)]
    #[must_use]
    pub fn fs20(&mut self) -> FS20_W<FSCFG_SPEC> {
        FS20_W::new(self, 20)
    }
    #[doc = "Bit 21 - Filter scale configuration"]
    #[inline(always)]
    #[must_use]
    pub fn fs21(&mut self) -> FS21_W<FSCFG_SPEC> {
        FS21_W::new(self, 21)
    }
    #[doc = "Bit 22 - Filter scale configuration"]
    #[inline(always)]
    #[must_use]
    pub fn fs22(&mut self) -> FS22_W<FSCFG_SPEC> {
        FS22_W::new(self, 22)
    }
    #[doc = "Bit 23 - Filter scale configuration"]
    #[inline(always)]
    #[must_use]
    pub fn fs23(&mut self) -> FS23_W<FSCFG_SPEC> {
        FS23_W::new(self, 23)
    }
    #[doc = "Bit 24 - Filter scale configuration"]
    #[inline(always)]
    #[must_use]
    pub fn fs24(&mut self) -> FS24_W<FSCFG_SPEC> {
        FS24_W::new(self, 24)
    }
    #[doc = "Bit 25 - Filter scale configuration"]
    #[inline(always)]
    #[must_use]
    pub fn fs25(&mut self) -> FS25_W<FSCFG_SPEC> {
        FS25_W::new(self, 25)
    }
    #[doc = "Bit 26 - Filter scale configuration"]
    #[inline(always)]
    #[must_use]
    pub fn fs26(&mut self) -> FS26_W<FSCFG_SPEC> {
        FS26_W::new(self, 26)
    }
    #[doc = "Bit 27 - Filter scale configuration"]
    #[inline(always)]
    #[must_use]
    pub fn fs27(&mut self) -> FS27_W<FSCFG_SPEC> {
        FS27_W::new(self, 27)
    }
