...
pub type R = crate::R<F0DATA0_SPEC>;
#[doc = "Register `F0DATA0` writer"]
pub type W = crate::W<F0DATA0_SPEC>;
...
#[doc = "Filter 0 data 0 register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`f0data0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`f0data0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
