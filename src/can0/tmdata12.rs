...
pub type R = crate::R<TMDATA12_SPEC>;
#[doc = "Register `TMDATA12` writer"]
pub type W = crate::W<TMDATA12_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn db4(&mut self) -> DB4_W<TMDATA12_SPEC> {
        DB4_W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Data byte 5"]
    #[inline(always)]
    #[must_use]
    pub fn db5(&mut self) -> DB5_W<TMDATA12_SPEC> {
        DB5_W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Data byte 6"]
    #[inline(always)]
    #[must_use]
    pub fn db6(&mut self) -> DB6_W<TMDATA12_SPEC> {
        DB6_W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Data byte 7"]
    #[inline(always)]
    #[must_use]
    pub fn db7(&mut self) -> DB7_W<TMDATA12_SPEC> {
        DB7_W::new(self, 24)
    }
}
...
pub struct TMDATA12_SPEC;
impl crate::RegisterSpec for TMDATA12_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`tmdata12::R`](R) reader structure"]
impl crate::Readable for TMDATA12_SPEC {}
#[doc = "`write(|w| ..)` method takes [`tmdata12::W`](W) writer structure"]
impl crate::Writable for TMDATA12_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets TMDATA12 to value 0"]
impl crate::Resettable for TMDATA12_SPEC {
