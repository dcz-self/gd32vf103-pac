...
pub type CH0CAPPSC_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
...
pub type CH0CAPFLT_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 4, O>;
...
pub type CH1CAPPSC_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
...
pub type CH1CAPFLT_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 4, O>;
impl R {
