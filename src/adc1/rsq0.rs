...
pub type RSQ12_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
...
pub type RSQ13_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
...
pub type RSQ14_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
...
pub type RSQ15_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
...
pub type RL_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rsq12(&mut self) -> RSQ12_W<RSQ0_SPEC> {
        RSQ12_W::new(self, 0)
    }
    #[doc = "Bits 5:9 - 14th conversion in regular sequence"]
    #[inline(always)]
    #[must_use]
    pub fn rsq13(&mut self) -> RSQ13_W<RSQ0_SPEC> {
        RSQ13_W::new(self, 5)
    }
    #[doc = "Bits 10:14 - 15th conversion in regular sequence"]
    #[inline(always)]
    #[must_use]
    pub fn rsq14(&mut self) -> RSQ14_W<RSQ0_SPEC> {
        RSQ14_W::new(self, 10)
    }
    #[doc = "Bits 15:19 - 16th conversion in regular sequence"]
    #[inline(always)]
    #[must_use]
    pub fn rsq15(&mut self) -> RSQ15_W<RSQ0_SPEC> {
        RSQ15_W::new(self, 15)
    }
    #[doc = "Bits 20:23 - Regular channel group length"]
    #[inline(always)]
    #[must_use]
    pub fn rl(&mut self) -> RL_W<RSQ0_SPEC> {
        RL_W::new(self, 20)
    }
